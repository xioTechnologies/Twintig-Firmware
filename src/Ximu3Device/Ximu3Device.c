...
static Context contexts[] = {
    {.defaultName = "Twintig"/*           */, .settings = &settingsArray[0], .nvm = &nvm0, .send = &send0, .led = &led0, .serialSetSettings = &SerialSetSettings, .hapticPlay = HapticPlay},
    {.defaultName = "Carpus IMU"/*        */, .settings = &settingsArray[1], .nvm = &nvm1, .send = &send1, .led = &led1, .imu = &imu1},
    {.defaultName = "I Metacarpal IMU"/*  */, .settings = &settingsArray[2], .nvm = &nvm2, .send = &send2, .led = &led2, .imu = &imu2},
    {.defaultName = "I Proximal IMU"/*    */, .settings = &settingsArray[3], .nvm = &nvm3, .send = &send3, .led = &led3, .imu = &imu3},
    {.defaultName = "I Distal IMU"/*      */, .settings = &settingsArray[4], .nvm = &nvm4, .send = &send4, .led = &led4, .imu = &imu4},
    {.defaultName = "II Metacarpal IMU"/* */, .settings = &settingsArray[5], .nvm = &nvm5, .send = &send5, .led = &led5, .imu = &imu5},
    {.defaultName = "II Proximal IMU"/*   */, .settings = &settingsArray[6], .nvm = &nvm6, .send = &send6, .led = &led6, .imu = &imu6},
    {.defaultName = "II Middle IMU"/*     */, .settings = &settingsArray[7], .nvm = &nvm7, .send = &send7, .led = &led7, .imu = &imu7},
    {.defaultName = "II Distal IMU"/*     */, .settings = &settingsArray[8], .nvm = &nvm8, .send = &send8, .led = &led8, .imu = &imu8},
    {.defaultName = "III Metacarpal IMU"/**/, .settings = &settingsArray[9], .nvm = &nvm9, .send = &send9, .led = &led9, .imu = &imu9},
    {.defaultName = "III Proximal IMU"/*  */, .settings = &settingsArray[10], .nvm = &nvm10, .send = &send10, .led = &led10, .imu = &imu10},
    {.defaultName = "III Middle IMU"/*    */, .settings = &settingsArray[11], .nvm = &nvm11, .send = &send11, .led = &led11, .imu = &imu11},
    {.defaultName = "III Distal IMU"/*    */, .settings = &settingsArray[12], .nvm = &nvm12, .send = &send12, .led = &led12, .imu = &imu12},
    {.defaultName = "IV Metacarpal IMU"/* */, .settings = &settingsArray[13], .nvm = &nvm13, .send = &send13, .led = &led13, .imu = &imu13},
    {.defaultName = "IV Proximal IMU"/*   */, .settings = &settingsArray[14], .nvm = &nvm14, .send = &send14, .led = &led14, .imu = &imu14},
    {.defaultName = "IV Middle IMU"/*     */, .settings = &settingsArray[15], .nvm = &nvm15, .send = &send15, .led = &led15, .imu = &imu15},
    {.defaultName = "IV Distal IMU"/*     */, .settings = &settingsArray[16], .nvm = &nvm16, .send = &send16, .led = &led16, .imu = &imu16},
    {.defaultName = "V Metacarpal IMU"/*  */, .settings = &settingsArray[17], .nvm = &nvm17, .send = &send17, .led = &led17, .imu = &imu17},
    {.defaultName = "V Proximal IMU"/*    */, .settings = &settingsArray[18], .nvm = &nvm18, .send = &send18, .led = &led18, .imu = &imu18},
    {.defaultName = "V Middle IMU"/*      */, .settings = &settingsArray[19], .nvm = &nvm19, .send = &send19, .led = &led19, .imu = &imu19},
    {.defaultName = "V Distal IMU"/*      */, .settings = &settingsArray[20], .nvm = &nvm20, .send = &send20, .led = &led20, .imu = &imu20},
};
