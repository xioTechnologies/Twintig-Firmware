...
const I2C i2cBB3 = {
    .start = I2CBB3Start,
    .repeatedStart = I2CBB3RepeatedStart,
    .stop = I2CBB3Stop,
    .send = I2CBB3Send,
    .sendAddressRead = I2CBB3SendAddressRead,
    .sendAddressWrite = I2CBB3SendAddressWrite,
    .receive = I2CBB3Receive,
};
static const I2CBB i2cBB = {
    .sclPin = I2CBB3_SCL_PIN,
    .sdaPin = I2CBB3_SDA_PIN,
    .halfClockCycle = I2CBB3_HALF_CLOCK_CYCLE,
};
